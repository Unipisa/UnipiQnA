...
namespace Microsoft.BotBuilderSamples.Dialog
{
    ...
    public class QnAMakerBaseDialog : QnAMakerDialog
    {
        ...
        public const string DefaultNoAnswer = "Non ho trovato risposte adeguate.";
        public const string DefaultCardTitle = "Volevi forse dire:";
        public const string DefaultCardNoMatchText = "Nessuna delle precedenti.";
        public const string DefaultCardNoMatchResponse = "Grazie per il tuo contributo.";
